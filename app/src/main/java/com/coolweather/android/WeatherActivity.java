...
public class WeatherActivity extends AppCompatActivity {
    ...
    private LinearLayout forestLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titltCity = (TextView) findViewById(R.id.title_city);
        titleUpadateTime = (TextView) findViewById(R.id.title_update_time);
        degreeText = (TextView) findViewById(R.id.degree_text);
        weatherInfoText = (TextView) findViewById(R.id.weather_info_text);
        forestLayout = (LinearLayout) findViewById(R.id.forecast_layout);
    ...
    private void showWeatherInfo(Weather weather) {
        ...
        for (Forecast forecast : weather.forecastList) {
            View view = LayoutInflater.from(this).inflate(R.layout.forecast_item, forestLayout, false);
    ...
    private void loadBingPic() {
        ...
        HttpUntil.sendOkHttpRequeset(requestBingPic, new Callback() {
            @Override
            public void onResponse(Call call, Response response) throws IOException {
